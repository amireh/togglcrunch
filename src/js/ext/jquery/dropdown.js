define([ 'jquery', 'lodash', 'jquery.jquerypp' ], function($, _) {
  'use strict';
  ...
  Dropdown.prototype = {
    ...
    /**
     * @property {jQuery} The trigger element.
     */
    $el: null,

    /**
     * @property {jQuery} The dropdown menu.
     */
    $menu: null,
    ...
    show: function(e) {
      ...
      this.$menu
        .animate({ height: 'show' }, { duration: this.options.duration })
    ...
    hide: function(e) {
      ...
      this.$menu
        .animate({ height: 'hide' }, { duration: this.options.duration }).promise()
