 ...
 */
(function() {
  var arrays, basicObjects, isBasicObject,
    __slice = [].slice;
  ...
  basicObjects = function(object) {
    if (!_.isBasicObject(object)) return [];
...
;(function(factory) {
    ...
    var modelOptions = ['url', 'urlRoot', 'collection', 'state' ];

    var DeepModel = Backbone.Model.extend({

        // Override constructor
        // Support having nested defaults by using _.merge instead of _.extend
